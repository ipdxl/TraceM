...
public final class OrdersTable {
	...
	public final static String CREATE_TABLE = "CREATE TABLE ORDERS ("
			...
			+ " ON UPDATE CASCADE ON DELETE NO ACTION" + ", AUFART		TEXT"
	...
	public final static String[] COLUMN_NAMES = new String[] { ADDRESS,
			ASSIGNED_STATUS, AUFART, AUFNR, AUFTEXT, CO_GSTRP, EXP_DAYS,
			EXP_STATUS, ID_PROGRAM, ORDER_STATUS, PARTNER, ZHOURS };
}